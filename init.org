...
(define-key doc-view-mode-map (kbd "C-r") 'image-scroll-down)
...
(eval-after-load 'autoinsert
  '(define-auto-insert '(python-mode . "Python Header")
     '("The header for all python files"
       "#!/usr/bin/env python3" \n
       "# -*- codeing: utf-8 -*-" \n
       "\"\"\"" \n
       "Created on " (format-time-string "%B %d %y") \n
       "Author github/twitter @iwahbe" \n
       "\"\"\"" \n
       |
       )))
