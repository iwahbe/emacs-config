...
** lsp-mode
This is the main lsp-interface for emacs. It is more complicated then [[https://github.com/joaotavora/eglot][eglot]], but
has the advantage of working over tramp, as well as a larger ecosystem.
